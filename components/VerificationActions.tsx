...
const buttonClass =
  "px-3 py-2 border border-gray-300 rounded-lg text-sm hover:bg-gray-50 flex items-center gap-1.5 transition-colors";
    ...
    <div className="flex flex-wrap gap-2 mb-6">
      ...
      {onViewAuditTrail ? (
        <button
          ...
          className={`${buttonClass} ${showAuditTrail ? "bg-blue-600 text-white border-blue-600 hover:bg-blue-700" : ""}`}
        >
