 ...
 *
 * This is the "Option 1" out-of-band path in
 * docs/operations/admin-authority-tiers.md — preferred over the bootstrap route
 * precisely because ADMIN_SECRET never needs a live value.
 *
