...
describe("result mapping", () => {
  ...
  it("F1 parity: team_workspaces_disabled (Case 1) is byte-identical to run_not_found/panel_absent (Case 2)", async () => {
    mockedOverrideWorkspaceReviewPanel.mockResolvedValueOnce({ ok: false, reason: "team_workspaces_disabled" });
    ...
    mockedOverrideWorkspaceReviewPanel.mockResolvedValueOnce({ ok: false, reason: "run_not_found" });
