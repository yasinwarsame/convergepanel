...
const HUB_GROUPS: HubGroup[] = [
  ...
  },
  {
    ...
    description: "Verify help center answers and audit knowledge base articles for accuracy using multiple AI models.",
  ...
  },
  {
    ...
    description: "Verify financial model assumptions — market size, growth rates, and benchmarks — using multi-model AI research.",
