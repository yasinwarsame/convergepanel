...
function FaqQ({ children }: { children: ReactNode }) {
  return <h3 className="mt-6 text-base font-semibold text-cp-text first:mt-0">{children}</h3>;
}

function FaqA({ children }: { children: ReactNode }) {
  return <p className="mt-2 text-sm leading-relaxed text-cp-muted">{children}</p>;
}

export default function HelpPage() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-10 sm:py-14">
      <h1 className="mb-2 text-3xl font-bold text-cp-text">How to use ConvergePanel</h1>
      <p className="text-sm text-cp-muted">
        Research mode and claim verification share the same idea: compare models before you trust an
        answer.
      </p>

      <div className="mt-8 space-y-10 text-cp-muted">
        <section>
          <h2 className="text-xl font-semibold text-cp-text">Getting started</h2>

          <FaqQ>How do I run my first research panel?</FaqQ>
          <FaqA>
            Sign in, open the <strong className="text-cp-text">Research</strong> tab, enter your question, choose at least two
          ...
          <FaqA>
            Open the <strong className="text-cp-text">Verify claim</strong> tab, paste a claim (a sentence or short passage),
        ...
        <section>
          <h2 className="text-xl font-semibold text-cp-text">Video verification</h2>
          <p className="mt-2 rounded-lg border border-amber-700/50 bg-amber-950/30 px-3 py-2 text-xs leading-relaxed text-amber-300">
          ...
          <FaqA>
            <strong className="text-cp-text">Authentic:</strong> Models reported no strong manipulation indicators. That does not
            mean the clip is necessarily genuine — it means no major red flags showed up in this pass.{" "}
            <strong className="text-cp-text">Likely manipulated:</strong> Multiple models flagged inconsistencies suggesting AI
            generation or digital editing; open the per-model evidence for specifics.{" "}
            <strong className="text-cp-text">Inconclusive:</strong> Models split or lacked confidence — human review is
            appropriate. <strong className="text-cp-text">Insufficient:</strong> The clip is too short, low resolution, or too
        ...
        <section>
          <h2 className="text-xl font-semibold text-cp-text">Understanding results</h2>
          ...
          <FaqA>
            You will see <strong className="text-cp-text">High</strong>, <strong className="text-cp-text">Medium</strong>, or <strong className="text-cp-text">Low</strong> next
          ...
          <FaqA>
            <strong className="text-cp-text">Strong</strong>, <strong className="text-cp-text">mixed</strong>, or <strong className="text-cp-text">weak</strong> summarizes how
          ...
          <FaqA>
            <strong className="text-cp-text">Confirmed</strong> — a large majority of models with usable verdicts rate the claim
            as accurate. <strong className="text-cp-text">Disputed</strong> — material disagreement (for example both accurate and
            inaccurate votes among usable models). <strong className="text-cp-text">Partially true</strong> — enough partial or
            qualified agreement that the core idea may hold but details need correction.{" "}
            <strong className="text-cp-text">Unverifiable</strong> — too many unknowns, too many unverifiable votes, or not
        ...
        <section>
          <h2 className="text-xl font-semibold text-cp-text">Audit trail</h2>
          ...
          <FaqA>
            ...
            <strong className="text-cp-text">View audit trail</strong> on a claim result; use <strong className="text-cp-text">Copy audit as JSON</strong>{" "}
            or <strong className="text-cp-text">Download</strong> for your files.
          </FaqA>
        ...
        <section>
          <h2 className="text-xl font-semibold text-cp-text">Governance &amp; review</h2>
          ...
          <FaqA>
            Open <strong className="text-cp-text">Profile</strong> → <strong className="text-cp-text">Governance Settings</strong>. Turn on{" "}
            <strong className="text-cp-text">Available as reviewer</strong> if you want others to assign you. To choose your own
          ...
          <FaqA>
            Reviewers open <strong className="text-cp-text">Governance</strong> → <strong className="text-cp-text">Review Queue</strong>. Each flagged run
        ...
        <section>
          <h2 className="text-xl font-semibold text-cp-text">Plans &amp; limits</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-cp-text">Troubleshooting</h2>
